    ...
    <div class="row">
        ...
        <div class="col d-flex justify-content-center ">
            <div class="container mt-4 pb-5 mx-auto">
                ...
                <a href="#" class="active fs-5 text-white text-decoration-none ms-2 pt-1 d-block"><img src="{{ asset('img/settings.svg') }}" class="img-fluid" alt=""> Product Management > <span class="fw-semibold">Add Product</span></a>
                </div>

                <div class="card shadow w-75 my-4 p-4 mx-auto">
                    <form action="{{ route('store_product') }}" method="POST" enctype="multipart/form-data" class="fs-5">
                        @csrf
                        <div class="mb-3">
                            <label for="profile" class="form-label">Add Image</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control fs-5 border-dark" id="title" name="title" placeholder="Title">
                            @error('title')
                            <span class="text-danger fw-semibold">Error message goes here</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control fs-5 border-dark" id="link" name="link" placeholder="Link">
                            @error('link')
                            <span class="text-danger fw-semibold">Error message goes here</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control fs-5 border-dark" id="description" name="description" rows="3" placeholder="Description"></textarea>
                            @error('description')
                            <span class="text-danger fw-semibold">Error message goes here</span>
                            @enderror
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        swal("Product Successfully Added", "{{ Session::get('message') }}", {
